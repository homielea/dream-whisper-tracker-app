...
<mild_prd_alignment>
  All specs must align with MILD's core framework:
  - **SLC**: Simple (one-tap interactions), Lovable (mystical design), Complete (full user journey)
  - **Must-Have Features**: Dream logging, AI summary, rituals, archive
  - **Success Metrics**: Daily logging >30% DAU, increased lucid recall, >70% delight
  - **Timeline Context**: Week 1 (logging), Week 2 (rituals/audios), Week 3 (insights), Week 4 (ship)
</mild_prd_alignment>
...
<context_analysis>
  ...
  <tech_stack>technical requirements (Lovable + Supabase + AI)</tech_stack>
  <prd_constraints>SLC framework and feature prioritization</prd_constraints>
</context_analysis>
...
<clarification_areas>
  <scope>
    ...
    - prd_alignment: which PRD feature category (Must/Should/Won't)
  </scope>
  <technical>
    - functionality specifics
    - UI/UX requirements (mystical design alignment)
    - integration points (Supabase + AI)
    - simplicity requirements (one-tap interactions)
  </technical>
  <metrics>
    - how this impacts daily logging engagement
    - connection to lucid recall improvement
    - delight factor considerations
  </metrics>
</clarification_areas>
